...
public class deletecustomer extends JFrame {
	...
	{ 
        ...
        b2.addActionListener(new ActionListener () {
			...
			{
		        int a=JOptionPane.showConfirmDialog(getContentPane(),"Confirm Deletion?");  
		        if(a==JOptionPane.YES_OPTION) {
		        	try {
		        		 Class.forName("net.ucanaccess.jdbc.UcanaccessDriver");
		                 Connection connection= DriverManager.getConnection("jdbc:ucanaccess://C:\\Users\\NAZIM MALIK\\OneDrive\\Documents\\CUSTOMERS_DB.accdb");
		                 System.out.println("Connected Successfully");
		                 String sql = "DELETE FROM Details WHERE ID='"+c1.getSelectedItem()+"'";
		                 Statement preparedStatement=connection.createStatement();
		        	    preparedStatement.executeUpdate(sql);
		                System.out.println("Deleted Successfully");
		                String sql1 = "DELETE FROM Bill WHERE ID='"+c1.getSelectedItem()+"'";
